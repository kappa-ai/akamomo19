...
const differentiators = [
  {
    number: "01",
    icon: Store,
    title: "자판기형이 아닌 직접 경험하는 공간",
    description: "단순히 물건을 파는 자판기형 매장이 아닌, 고객이 직접 보고 만지며 선택할 수 있는 체험 중심의 공간을 제공합니다.",
  ...
  },
  {
    number: "03",
    icon: Heart,
    title: "판매 공간이 아닌 하나의 데이트코스",
    description: "커플들이 함께 방문하여 즐길 수 있는 특별한 데이트 코스로서의 가치를 제공하여. 새로운 경험을 선사합니다.",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            기존 무인 성인용품점과는 완전히 다른 새로운 개념의 라이프스타일 매장
          </p>
        </div>
